...
function get_content_excerpt($content, $length = 70){
  ...
  $content =  preg_replace(SIMPLICITY_URL_REG, '', $content); //URLを取り除く
...
//セルフピンバック禁止
if ( !function_exists( 'sp_no_self_ping' ) ) {
...
//ファビコンタグを表示
if ( !function_exists( 'the_favicon_tag' ) ) {
...
//アップルタッチアイコンを表示
if ( !function_exists( 'the_apple_touch_icon_tag' ) ) {
...
if ( !function_exists( 'get_simplicity_local_dir' ) ) {
...
if ( !function_exists( 'file_exists_in_child_theme' ) ) {
...
//アップロード可能なファイルの設定
if ( !function_exists( 'my_upload_mimes' ) ) {
...
if ( !function_exists( 'post_page_all' ) ) {
...
if ( !function_exists( 'my_comment_form_defaults' ) ) {
...
if ( !function_exists( 'simplicity_theme_add_editor_styles' ) ) {
...
if ( !function_exists( 'css_custum_to_css_file' ) ) {
...
//パーツスキンファイルが存在しているか
if ( !function_exists( 'is_parts_skin_file' ) ) {
...
if ( !function_exists( 'get_pearts_base_skin' ) ) {
...
if ( !function_exists( 'get_skins_js_uri' ) ) {
...
if ( !function_exists( 'get_skins_js_local_dir' ) ) {
...
if ( !function_exists( 'get_theme_local_dir' ) ) {
...
//統一パーツスキンとなるファイルの取得
if ( !function_exists( 'get_parts_skin_file_uri' ) ) {
...
if ( !function_exists( 'is_list_index_first' ) ) {
...
if ( !function_exists( 'is_entry_card_style' ) ) {
...
//子テーマを利用しているか
if ( !function_exists( 'is_child_theme_enable' ) ) {
...
if ( !function_exists( 'add_universal_analytics_code' ) ) {
...
//ページが分割ページか
if ( !function_exists( 'is_page_multi' ) ) {
...
//分割ページの何ページ目か
if ( !function_exists( 'get_multi_page_number' ) ) {
