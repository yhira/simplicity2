...
<?php if ( get_google_plus_follow_id() )://Google＋フォローボタンを表示するか ?><li class="google-plus-page"><a href="//plus.google.com/<?php echo esc_html( get_google_plus_follow_id() ); //Google＋フォローIDの取得 ?>" target="_blank" title="<?php _e( 'Google＋をフォロー', 'simplicity2' ) ?>" rel="nofollow publisher"><span class="icon-google-plus-logo"></span></a></li><?php endif; ?>
...
<?php if ( get_line_at_follow_id() )://LINE@フォローボタンを表示するか ?><li class="line-page"><a href="//line.naver.jp/ti/p/<?php echo esc_html(  get_line_at_follow_id() ); //YouTubeフォローURLの取得 ?>" target="_blank" title="<?php _e( 'LINE@をフォロー', 'simplicity2' ) ?>" rel="nofollow"><span class="icon-line-logo"></span></a></li><?php endif; ?>
...
<?php if ( is_feedly_follow_btn_visible() )://feedlyフォローボタンを表示するか ?><li class="feedly-page"><a href='//feedly.com/index.html#subscription%2Ffeed%2F<?php echo rawurlencode(get_bloginfo("rss2_url")); ?>' target='blank' title="<?php _e( 'feedlyで更新情報を購読', 'simplicity2' ) ?>" rel="nofollow"><span class="icon-feedly-logo"></span></a></li><?php endif; ?>
