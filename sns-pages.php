...
<?php if ( is_feedly_follow_btn_visible() )://feedlyフォローボタンを表示するか ?><li class="feedly-page"><a href='//feedly.com/index.html#subscription/feed/<?php bloginfo("rss2_url"); ?>' target='blank' title="<?php _e( 'feedlyで更新情報を購読', 'simplicity2' ) ?>" rel="nofollow"><span class="icon-feedly-logo"></span></a></li><?php endif; ?>
