...
<?php if ( get_hatebu_follow_id() )://はてブフォローボタンを表示するか ?><li class="hatebu-page"><a href="//b.hatena.ne.jp/<?php echo esc_html( get_hatebu_follow_id() ); //はてブフォローIDの取得 ?>" target="_blank" title="はてブをフォロー" rel="nofollow"><span class="icon-hatebu-square"></span></a></li><?php endif; ?>
...
<?php if (  get_flickr_follow_id() )://Flickrフォローボタンを表示するか ?><li class="flickr-page"><a href="//www.flickr.com/photos/<?php echo esc_html(  get_flickr_follow_id() ); //YFlickrフォローIDの取得 ?>" target="_blank" title="Flickrをフォロー" rel="nofollow"><span class="fa fa-flickr"></span></a></li><?php endif; ?>
<?php if ( get_line_at_follow_id() )://LINE@フォローボタンを表示するか ?><li class="line-page"><a href="//line.naver.jp/ti/p/%40<?php echo esc_html(  get_line_at_follow_id() ); //YouTubeフォローURLの取得 ?>" target="_blank" title="LINE@をフォロー" rel="nofollow"><span class="icon-line-square"></span></a></li><?php endif; ?>
<?php $push7 = fetch_push7_info();
if ( get_push7_follow_app_no() && $push7 )://Push7フォローボタンを表示するか
 ?><li class="push7-page"><a href='https://<?php echo $push7->domain; ?>' target='blank' title="push7で更新情報を購読" rel="nofollow"><span class="icon-push7-square"></span></a></li><?php endif; ?>
<?php if ( is_feedly_follow_btn_visible() )://feedlyフォローボタンを表示するか ?><li class="feedly-page"><a href='//feedly.com/index.html#subscription%2Ffeed%2F<?php echo rawurlencode(get_bloginfo("rss2_url")); ?>' target='blank' title="feedlyで更新情報を購読" rel="nofollow"><span class="icon-feedly-square"></span></a></li><?php endif; ?>
