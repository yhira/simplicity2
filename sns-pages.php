...
<?php if ( get_line_at_follow_id() )://LINE@フォローボタンを表示するか ?><li class="line-page"><a href="//line.naver.jp/ti/p/<?php echo esc_html(  get_line_at_follow_id() ); //YouTubeフォローURLの取得 ?>" target="_blank" title="LINE@をフォロー" rel="nofollow"><span class="icon-line-logo"></span></a></li><?php endif; ?>
