...
<div class="sns-buttons sns-buttons-pc">
  ...
  <ul class="snsb clearfix">
    ...
    <li class="twitter-btn"><a href="<?php echo get_twitter_share_url(); ?>" data-url="<?php the_permalink(); ?>" data-text="<?php the_title_attribute(); ?>" data-count="<?php echo ($g_is_small ? 'horizontal' : 'vertical') ?>" data-related="<?php echo is_twitter_related_follow_enable() ? get_twitter_follow_id() : '' ;//ツイート後にフォローを促す ?>">Tweet</a><script type="text/javascript" src="//platform.twitter.com/widgets.js"></script>
    </li>
    <?php endif; ?>
