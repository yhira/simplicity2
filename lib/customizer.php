...
function theme_customize_register($wp_customize) {
  ...
  $wp_customize->add_setting( 'link_color', array(
    'default' => LINK_COLOR,
    'sanitize_callback' => 'simplicity_sanitize_text',
  ) );
  ...
  $wp_customize->add_setting('header_height', array(
    'default' => '100',
    'sanitize_callback' => 'simplicity_sanitize_number',
  ));
  ...
  $wp_customize->add_setting( 'header_logo_url', array(
    'sanitize_callback' => 'simplicity_sanitize_file_url',
  ) );
  ...
  $wp_customize->add_setting('header_logo_enable', array(
    'sanitize_callback' => 'simplicity_sanitize_check',
  ));
...
//モバイル本文文字サイズ
  ...
  $wp_customize->add_setting('top_page_meta_description', array(
    'default' => '',
    'sanitize_callback' => 'simplicity_sanitize_html_text',
  ));
  ...
  $wp_customize->add_setting('exclude_article_ids', array(
    'default' => '',
    'sanitize_callback' => 'simplicity_sanitize_id_comma_text',
  ));
...
', 'simplicity2' ) : '',
  ...
  $wp_customize->add_setting('blog_card_external_cache_days', array(
    'default' => 90,
    'sanitize_callback' => 'simplicity_sanitize_cache_days',
  ));
  ...
  $wp_customize->add_setting( 'amp_adsense_code', array(
    'default'   => '',
    'sanitize_callback' => 'simplicity_sanitize_adsense_code',
  ) );
  // 管理画面で表示する設定
...
//トラッキングIDの取得
if ( !function_exists( 'get_tracking_id' ) ):
