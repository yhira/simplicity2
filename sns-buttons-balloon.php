    ...
    <li class="balloon-btn twitter-balloon-btn">
      <span class="balloon-btn-set">
        <span class="arrow-box">
          <a href="//twitter.com/search?q=<?php echo urlencode( simplicity_punycode_encode( get_permalink() ) ); ?><?php echo get_twitter_via_param(); //ツイートにメンションを含める ?><?php echo get_twitter_related_param();//ツイート後にフォローを促す ?>" target="blank" class="arrow-box-link twitter-arrow-box-link" rel="nofollow">
