...
<div class="sns-buttons sns-buttons-pc">
  ...
  <ul class="snsb snsb-balloon clearfix">
    ...
    <li class="balloon-btn feedly-balloon-btn">
      <span class="balloon-btn-set">
        <span class="arrow-box">
          <a href="//feedly.com/i/subscription/feed/<?php bloginfo('rss2_url'); ?>" target="blank" class="arrow-box-link feedly-arrow-box-link" rel="nofollow">
        ...
        <a href="//feedly.com/i/subscription/feed/<?php bloginfo('rss2_url'); ?>" target="blank" class="balloon-btn-link feedly-balloon-btn-link" rel="nofollow">
